...
\cite{ohark}
Tässä tutkielmassa käsiteltävät arkkitehtuurit koostuvat oletusarkkitehtuurin (framework) tai sovellusaluemallin (domain model) tyylisistä jaotteluista. 
Reuna-arkkitehtuurit kuvaavat järjestelmän toiminnallisia osia korkealla tasolla. 
Yleensä toiminnalliset osat on jaettu loogisiin kokonaisuuksiin, eli toimintoihin perustuviin kokoniasuuksiin. Reuna-arkkitehtuurit asettavat rajoitteita myös fyysiselle sijoittumiselle, jolloin osa toimijoista on jaoteltu fyysisiin komponentteihin. Joskin kappaleessa \ref{nfv} esiteltävä NFV tekee asioiden jakamisen fyysisin kokonaisuuksiin hieman dynaamisempaa. 
...
Kappaleessa \ref{reunatoimijat} esitetyn jaon mukaan tässä tutkielmassa reuna-arkkitehtuurilla keskitytään reunasolmun ja reuna-alustan toiminnalliseen määrittelyyn.
Reuna-arkkitehtuuri jättää avoimeksi reunasovelluksien toiminnan.
