...
ETSI:n MEC spesifikaatio käsittelee reunalaskentaa korkealla tasolla.
%Spesifikaatio asettaa vaatimuksia sekä tarjoaa mahdollisuuksia.
ETSI MEC tekniset vaatimukset on jaettu kolmeen osaan: Yleisiin periaatteisiin, yleisiin vaatimuksiin ja muihin vaatimuksiin.
...
NFV yhteensopivuus täyttyy tämän tutkielman reuna-arkkitehtuureissa. NFV yhteensopivuuden tavoitteena on että reunajärjestelmä ja mobiiliverkko voisivat jakaa resursseja.
...
Samaa palveluvaatimusta oletetaan myös mobiiliverkossa toimivalta reunalaskennalta.
...
Mitään erityistä palvelun laadullista vaatimusta ei ole ETSI:n dokumenteissa asetettu, mutta osa reuna-arkkitehtuureista on ottanut lähtökohdakseen että pelkkä yhteyden ylläpitäminen reunalaskentaan ei riitä vaan sen tulee myös seurata asiakaslaitetta paremman palvelun laadun takaamiseksi.


Liikkuvuuden tukeminen tarkoittaa mobiiliverkkojen kontekstissa asiakaslaitteen handoverin tukemista. 
Liikkuvuuden tukeminen tarkoittaa reuna-arkkitehtuureissa reunalaskennan siirtoa ja yhteyden päivittämistä. Reunalaskennan siirtäminen on pääasiassa tuettuna live migraation avulla. 
