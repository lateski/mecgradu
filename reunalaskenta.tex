...
SCC (Small Cell Cloud) perusidea on reunapalvleuiden integroiminen osaksi olemassa 
olevaa LTE-verkkoinfrastruktuuria. Paveluita tuotettaisiin tukiasemiin (Base Station) sijoitetuilla palvelinresursseilla. Televerkkojen käyttö palvelun tarjoamiseen rajoittaa Täten palvelun kohteena on pääasiassa
älypuhelit ja muut televerkossa toimivat laitteet. 
