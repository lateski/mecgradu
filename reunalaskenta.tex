...
Reunan luonteesta johtuen cloudletin oletetaan ylläpitävän ainoastaan sellaisia palveluita jotka käyttävät reunaa hetkellisesti tai väliaikaisesti \citep{satya09}. Cloudlettiä ei ole siis tarkoitettu pidempiaikaiseen tallennukseen, vaan enemminkin suoritusaikaisten tarpeiden täyttämiseen. 
...
SCC (Small Cell Cloud, pienisoluinen pilvi?) perusidea on reunapalveluiden integroiminen osaksi LTE-verkkoinfrastruktuuria. 
...
Koska solut ovat muuttumassa pienemmiksi, tukiasemat tulevat fyysisesti lähemmäksi käyttäjää.

SCC:ssä reunapalveluiden tuottamiseen käytettäisiin olemassa  matkapuhelinverkkoa, rajaisi se myös asiakaslaitteet älypuhelimiin ja muihin tätä verkkoa käyttäviin laitteisiin. Lisäksi ehdotetun järjestelmän mukaan reunasolmujen palvelimet jakavat resursseja tukiaseman kanssa. Tällaisella järjestelyllä on sekä hyvät ja huonot puolensa. \cite{puente15seamless} esittelevät julkaisussaan ratkaisun, jossa reunasolmun ja asiakaslaitteen välisen liikenne on erotettu kaikesta muusta mobiiliverkon liikenteestä. Koska tukiasemat eivät käsittele IP kerrosta, täytyy liikenteen tukiasemassa sijaitsevalle reunapalvelulle ohjata jollain toisella tavalla \cite{puente15seamless}. 
...
SCM (Small Cell Manager) on SCC arkkitehtuurin hallinnasta vastaava komponentti. SCM tehtävä on jakaa resursseja tilannekohtaisesti. Se tietää radion ja SCeNBce solmujen tilat jolloin se voi myös tehdä päätöksiä virtuaalikoneiden pystyttämisestä "poikkeavaan" sijaintiin.  

SCC:n arkkitehtuurin kompastuskivenä saattaa olla niiden ylläpidettävyys, jossa matkapuhelinverkko-operaattori on vastuussa reunasolmun ylläpidosta, koska se on tiukasti sidoksissa tukiasemaan\cite{lobillo15scc}.
