...
Virtuaalikoneisiin pohjautuva cloudlet\cite{satya09} on yksi tunnetuimmista reunapalveluiden konsepteista. Cloudletit ovat pohjimmiltaan tavallisia virtuaalikoneinstansseja.
Käyttäjäkohtaisien virtuaalikoneiden ylläpitäminen jokaisella reunasolmulla on kuitenkin mahdoton ajatus resurssien näkökulmasta.
...
Kun käyttäjä lopettaa cloudletin käyttämisen, saatetaan haluta tallentaa cloudletin tila käyttäjän paluuta varten. Cloudletin virtuaali-instanssia ei tallenneta kokonaisena vaan ainaostaan käyttäjän siihen tekemät muutokset. Käyttäjän tekemät muutokset saadaan erotettua vertaamalla käyttäjän cloudlet-instanssia cloudlet-pohjaan. 
Käyttäjäkohtaisien muutoksien tallentaminen vie huomattavasti vähemmän tallennustilaa, sekä siirrettäessä säästävät verkkokapasiteettiä pienemmästä koostaan johtuen.
Tämä kuitenkin tarkoittaa että jokaisella reunasolmulla tulee olla cloudlet-pohja saatavilla ja käyttäjien cloudlettien on pohjauduttava johonkin rajalliseen määrään erilaisia cloudlet pohjia.
